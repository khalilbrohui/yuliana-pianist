...
$params = [];
$pageTitle = 'Yuliana Pianist - Clases de Música Premium y Lecciones';
$pageDescription = 'Aprende música y piano con instructores de primer nivel. Reserva tu clase de prueba gratuita presencial u online.';
...
if ($route === '/' || $route === '/home') {
    ...
    $pageTitle = 'Reservar Clase de Prueba Gratis - Yuliana Pianist';
} elseif ($route === '/registration') {
    $viewFile = 'views/registration_page.php';
    $pageTitle = 'Portal de Estudiantes - Yuliana Pianist';
} elseif ($route === '/dashboard') {
    $viewFile = 'views/student_dashboard.php';
    $pageTitle = 'Panel de Estudiantes - Yuliana Pianist';
} elseif ($route === '/admin') {
    $viewFile = 'views/admin_dashboard.php';
    $pageTitle = 'Panel de Administración - Yuliana Pianist';
} elseif ($route === '/contact') {
    $viewFile = 'views/contact_page.php';
    $pageTitle = 'Contacto - Yuliana Pianist';
} elseif ($route === '/blog') {
    ...
    $viewFile = 'views/home.php';
    $pageTitle = 'Página No Encontrada - Yuliana Pianist';
}
